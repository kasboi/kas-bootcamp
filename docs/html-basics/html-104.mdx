...
```html showLineNumbers {6-7,47-48}
<body>
    <!--This is a comment -->
...
We use classes to identify multiple one or multiple elements. Unlike `id`, we can apply a single class to multiple elements. We would delve more into this when we start styling our elements
